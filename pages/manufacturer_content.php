<?php
    ...
    $query_result = $obj_app->select_product_info_by_manufacturer_id($manufacturer_id);
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="main_category_right cat-2">
                    <div class="row">
                        <?php while ($manufacturer_product = mysqli_fetch_assoc($query_result)) { ?>
                        <div class="col-md-3 col-sm-4 col-xs-12">
                            <div class="main_cat_item">
                                <div class="item">
                                    <div class="item-img">
                                        <img src="assets/<?php echo $manufacturer_product['product_image'] ;?>" alt="" style="height: 200px; width: 200px; " />
                                    ...
                                    <div class="item-sub">
                                        <a href="product-detail.html"><h5><?php echo $manufacturer_product['product_name'] ;?></h5></a>
                                        <p>BDT <?php echo $manufacturer_product['product_price'] ;?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
