...
jQuery(document).ready(function($){
	...
	//product image with tab and zoom
	    $("#zoom_02").elevateZoom({tint:true, tintColour:'#FF6766', tintOpacity:0.0});
	    $("#zoom_03").elevateZoom({tint:true, tintColour:'#FF6766', tintOpacity:0.0});
	    $("#zoom_04").elevateZoom({tint:true, tintColour:'#FF6766', tintOpacity:0.0});
